...
for i in range(0,4):
    env_name = 'PGsql_Train_Join_Job_cv{}'.format(i)
    file_name = '/data0/chenjin/join_query_optimization/agents/queries/crossval_sens/job_queries_simple_crossval_{}_train.txt'.format(i)
register(
