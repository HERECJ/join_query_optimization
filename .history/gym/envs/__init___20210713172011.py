...
register(
    id = 'Split_Train_Join_Job_Cross_v0',
    entry_point = 'gym.envs.database2:Train_Job_Cross_v0'
)

register(
    id = 'Split_Train_Join_Job_Cross_v1',
    entry_point = 'gym.envs.database2:Train_Job_Cross_v1'
)

register(
    id = 'Split_Train_Join_Job_Cross_v2',
    entry_point = 'gym.envs.database2:Train_Job_Cross_v2'
)

register(
    id = 'Split_Train_Join_Job_Cross_v3',
    entry_point = 'gym.envs.database2:Train_Job_Cross_v3'
)

register(
    id = 'Split_Eval_Join_Job_Cross_v0',
    entry_point = 'gym.envs.database2:Evaluate_Job_Cross_v0'
)

register(
    id = 'Split_Eval_Join_Job_Cross_v1',
    entry_point = 'gym.envs.database2:Evaluate_Job_Cross_v1'
)

register(
    id = 'Split_Eval_Join_Job_Cross_v2',
    entry_point = 'gym.envs.database2:Evaluate_Job_Cross_v2'
)

register(
    id = 'Split_Eval_Join_Job_Cross_v3',
    entry_point = 'gym.envs.database2:Evaluate_Job_Cross_v3'
)
