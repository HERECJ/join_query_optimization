...
class Train_Join_Job(gym.Env):
    ...
    def __init__(self, file_path=None):
        ...
        self.action_space = spaces.Discrete(num_of_relations * (num_of_relations - 1))
    ...
    def reset(self):
        ...
        self.cost = {'max': 1.e+13, 'min': 1.e+6}
...
class Evaluate_Join_Job(Train_Join_Job):
    def __init__(self, file_path):
        super().__init__(file_path=file_path)
        self.sql_query_num = 0
        print('Evaluation episodes : ', len(self.sql_query))
        self.num_test = len(self.sql_query)
        # config need modify
    
    def reset(self):
        idx_sql = self.sql_query_num // len(self.self.num_test)
        print("Eval data, ", self.sql_query_num, len(self.sql_query))
        sql = self.sql_query[self.sql_query_num].replace(";", "")
    ...
    def step(self, action_num):
        return super().step(action_num)


# class Train_Job_Cross_v0(Train_Join_Job):
#     def __init__(self):
#         super().__init__()
#         file_path = "/data0/chenjin/join_query_optimization/agents/queries/crossval_sens/job_queries_simple_crossval_0_train.txt"
#         self.sql_query = list(open(file_path))


# class Evaluate_Job_Cross_v0(Evaluate_Join_Job):
#     def __init__(self):
#         super().__init__()
#         file_path = "/data0/chenjin/join_query_optimization/agents/queries/crossval_sens/job_queries_simple_crossval_0_test.txt"
#         self.sql_query = list(open(file_path))


# class Train_Job_Cross_v1(Train_Join_Job):
#     def __init__(self):
#         super().__init__()
#         file_path = "/data0/chenjin/join_query_optimization/agents/queries/crossval_sens/job_queries_simple_crossval_1_train.txt"
#         self.sql_query = list(open(file_path))


# class Evaluate_Job_Cross_v1(Evaluate_Join_Job):
#     def __init__(self):
#         super().__init__()
#         file_path = "/data0/chenjin/join_query_optimization/agents/queries/crossval_sens/job_queries_simple_crossval_1_test.txt"
#         self.sql_query = list(open(file_path))

# class Train_Job_Cross_v2(Train_Join_Job):
#     def __init__(self):
#         super().__init__()
#         file_path = "/data0/chenjin/join_query_optimization/agents/queries/crossval_sens/job_queries_simple_crossval_2_train.txt"
#         self.sql_query = list(open(file_path))


# class Evaluate_Job_Cross_v2(Evaluate_Join_Job):
#     def __init__(self):
#         super().__init__()
#         file_path = "/data0/chenjin/join_query_optimization/agents/queries/crossval_sens/job_queries_simple_crossval_2_test.txt"
#         self.sql_query = list(open(file_path))


# class Train_Job_Cross_v3(Train_Join_Job):
#     def __init__(self):
#         super().__init__()
#         file_path = "/data0/chenjin/join_query_optimization/agents/queries/crossval_sens/job_queries_simple_crossval_3_train.txt"
#         self.sql_query = list(open(file_path))


# class Evaluate_Job_Cross_v3(Evaluate_Join_Job):
#     def __init__(self):
#         super().__init__()
#         file_path = "/data0/chenjin/join_query_optimization/agents/queries/crossval_sens/job_queries_simple_crossval_3_test.txt"
#         self.sql_query = list(open(file_path))