...
class CM1PostgresCardJob0(gym.Env):
  ...
  def __init__(self):
    ...
    self.sql_query = list(open('/data0/chenjin/mt-join-query-optimization-with-drl/agents/queries/crossval_sens/job_queries_simple_crossval_0_test.txt'))
    self.sql_query_num = 0
  ...
  def reset(self):
    ...
    sql_query = random.choice(list(open('/data0/chenjin/mt-join-query-optimization-with-drl/agents/queries/crossval_sens/job_queries_simple_crossval_0_train.txt'))).replace(";", "")
