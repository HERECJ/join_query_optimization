...
class CM1PostgresCardJob2(gym.Env):
  ...
  def reset(self):
    ...
    sql_query = random.choice(list(open('/data0/chenjin/mt-join-query-optimization-with-drl/agents/queries/crossval_sens/job_queries_simple_crossval_2_test.txt'))).replace(";","")
