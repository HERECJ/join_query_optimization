...
class CM1PostgresCardJob(gym.Env):
  ...
  def __init__(self):
    ...
    # self.sql_query = list(open('~//PycharmProjects/mt-join-queryoptimization-with-drl/agents/queries/crossval/job_queries_simple_crossval_7400_3_test.txt'))
    self.sql_query = list(open('/data0/chenjin/mt-join-query-optimization-with-drl/agents/queries/crossval/job_queries_simple_crossval_7400_3_test.txt'))
  ...
  def reset(self):
    ...
    # sql_query = random.choice(list(open('~//PycharmProjects/mt-join-queryoptimization-with-drl/agents/queries/crossval/job_queries_simple_crossval_7400_0_train.txt'))).replace(";", "")

    sql_query = random.choice(list(open('/data0/chenjin/mt-join-query-optimization-with-drl/agents/queries/crossval/job_queries_simple_crossval_7400_0_train.txt'))).replace(";", "")
