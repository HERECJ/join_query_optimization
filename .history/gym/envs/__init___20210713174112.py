...
for i in range(0,4):
    train_env_name = 'PGsql_Train_Join_Job_cv{}'.format(i)
    train_file_name = '/data0/chenjin/join_query_optimization/agents/queries/crossval_sens/job_queries_simple_crossval_{}_train.txt'.format(i)


    test_env_name = 'PGsql_Eval_Join_Job_cv{}'.format(i)
    train_file_name = '/data0/chenjin/join_query_optimization/agents/queries/crossval_sens/job_queries_simple_crossval_{}_test.txt'.format(i)
