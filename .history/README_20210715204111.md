...
1. Install Python 3.*
1. Clone repository
1. Install virtual environment from `requirements_new.txt` in the project folder
...
To execute the experiments you can start `execute._new_env.py`  in `/agents/run/`.
